...
class DattorroReverb extends AudioWorkletProcessor {
  ...
  constructor(options) {
    ...
    this._taps = Int16Array.from(
      ...
      (x) => Math.round(x * globalThis.sampleRate),
    );
  }
  ...
  process(inputs, outputs, parameters) {
    ...
    const ex = parameters.excursionRate[0] / globalThis.sampleRate;
    const ed = (parameters.excursionDepth[0] * globalThis.sampleRate) / 1000;
...
globalThis.registerProcessor("DattorroReverb", DattorroReverb);
