...
export const piccolo = {
  ...
  peakingFilters: [{ frequency: 900, gain: 2, q: 3.0 }],
};
...
export const contrabassoon = {
  ...
  peakingFilters: [
    { frequency: 250, gain: 2, q: 3.0 },
    { frequency: 450, gain: 2, q: 3.0 },
  ],
};
...
export const hammeredDulcimer = {
  ...
  peakingFilters: [
    { frequency: 400, gain: 3.0, Q: 3.0 },
    { frequency: 700, gain: 3.0, Q: 3.0 },
    { frequency: 900, gain: 3.0, Q: 3.0 },
    { frequency: 1300, gain: 3.0, Q: 2.0 },
